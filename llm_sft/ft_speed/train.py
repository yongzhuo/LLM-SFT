...
from llm_sft.ft_speed.config import CUDA_VISIBLE_DEVICES, USE_TORCH, CPU_NUMS  # from config
...
from llm_sft.ft_speed.config import PATH_MODEL_PRETRAIN, DATA_PATH, MODEL_SAVE_DIR, REPO_ID
from llm_sft.ft_speed.config import MICRO_BATCH_SIZE, BATCH_SIZE, GRADIENT_ACCUMULATION_STEPS
from llm_sft.ft_speed.config import LEARNING_RATE, EPOCHS, SAVE_STEPS, VAL_SET_SIZE, TARGET_MODULES
from llm_sft.ft_speed.config import IS_PARALLELIZABLE, MODEL_PARALLEL, USE_CACHE
from llm_sft.ft_speed.config import MAX_LENGTH_Q, MAX_LENGTH_A, MAX_LENGTH_QA
from llm_sft.ft_speed.config import LORA_DROPOUT, LORA_ALPHA, LORA_R
from llm_sft.ft_speed.config import DEEPSPEED_CONF
