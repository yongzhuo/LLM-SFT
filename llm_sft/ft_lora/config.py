...
# @time    : 2023/3/5 21:29
# @author  : Mo
# @function: config, ymcui/Chinese-LLaMA-Alpaca
...
PATH_MODEL_PRETRAIN = ""
PATH_MODEL_LORA = ""
REPO_ID_LORA = "ziqingyang/chinese-alpaca-lora-7b"
REPO_ID = "decapoda-research/llama-7b-hf"
PATH_MODEL_PRETRAIN = PATH_MODEL_PRETRAIN if PATH_MODEL_PRETRAIN else REPO_ID
PATH_MODEL_LORA = PATH_MODEL_LORA if PATH_MODEL_LORA else REPO_ID_LORA
DATA_PATH = "../dataset/alpaca_gpt4_data_zh.json"
